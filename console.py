...
record1 = Record('Blue', artist1, 'Folk', 1971, 15.00, 30.00, 5)
record_repository.save(record1)
record2 = Record('Extraordinary Machine', artist2, 'Pop & Rock', 2005, 10.50, 20.00, 2)
record_repository.save(record2)
record3 = Record('Room With A View', artist4, 'Jazz', 2000, 13.50, 25.00, 1)
record_repository.save(record3)
record4 = Record('Blue Train', artist3, 'Jazz', 2022, 15.50, 35.00, 10)
record_repository.save(record4)
record5 = Record('Both Sides Now', artist1, 'Folk', 1969, 12.00, 25.00, 3)
